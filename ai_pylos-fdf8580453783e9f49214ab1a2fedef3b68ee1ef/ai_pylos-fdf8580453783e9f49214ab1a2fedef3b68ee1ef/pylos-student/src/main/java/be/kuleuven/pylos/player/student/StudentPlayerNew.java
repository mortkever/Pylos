...
public class StudentPlayerNew extends PylosPlayer {
	...
	private Action getBestMove(PylosGameIF game, PylosBoard board) {
		...
		SearchTreeNew tree = new SearchTreeNew(depth, 1, simulator, board, this, game, null, 1, Integer.MIN_VALUE, Integer.MAX_VALUE); //6
