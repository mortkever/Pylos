...
public class PylosGuiController implements PylosGameObserver, PylosPlayerObserver {
    ...
    public void startBattle() {
        ...
        new Thread(() -> {
            battleStop = false;
            int n = tfBattles.getText().isEmpty() ? Integer.MAX_VALUE : Integer.parseInt(tfBattles.getText());
