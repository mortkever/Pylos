...
public class PylosSquare {
    ...
    private final int[] nOfColor = new int[2]; // [0] for Player.LIGHT, [1] for Player.DARK
    private final PylosLocation[] locations = new PylosLocation[4];
    private final PylosLocation topLocation;
    private int n;
