...
import be.kuleuven.pylos.player.SearchTreev1;


public class StudentPlayerV1 extends PylosPlayer {
	...
	private Action getBestMove(PylosGameIF game, PylosBoard board) {
		...
		SearchTreev1 tree = new SearchTreev1(depth, 1, simulator, board, this, game, null, 1, Integer.MIN_VALUE, Integer.MAX_VALUE, this.PLAYER_COLOR); //6
