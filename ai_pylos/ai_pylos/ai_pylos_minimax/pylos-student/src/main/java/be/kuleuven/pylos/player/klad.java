public class EvaluatorNew {
	...
	private static int EXCESS_RESERVE_SCORE = 150; // aantal bollen meer dan de tegenstander
	private static int TWO_REMOVE_BONUS_SCORE = 120; 
	private static int INCOMPLETE_OPPONENT_SQUARE_SCORE = -50; // vierkanten 3/4 kralen van de tegenstander
	private static int STRANGE_SQUARE_SCORE = -100; // gemengde vierkanten, wordt afgetrokken
	private static int HIGHER_THAN_OPPONENT_SCORE = 400; //Z score
	...
	private static int WEIGHT_ENDGAME = 2;   // reservebollen meer waard in endgame
